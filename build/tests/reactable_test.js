...
describe('Reactable', function () {
    ...
    describe('Adding a <Tfoot>', function () {
        before(function () {
            ReactDOM.render(React.createElement(
                Reactable.Table,
                { className: 'table', id: 'table', sortable: ['Name'], filterable: ['Name', 'Age'], filterClassName: 'new-class' },
    ...
    describe('table headers', function () {
        describe("with hideTableHeader prop on <Table>", function () {
            before(function () {
                ReactDOM.render(React.createElement(Reactable.Table, { className: 'table', id: 'table', data: [{ Name: 'Griffin Smith', Age: '18' }, { Age: '23', Name: 'Lee Salminen' }, { Age: '28', Position: 'Developer' }, { Name: 'Leonor Hyatt', Position: null }], hideTableHeader: true }), ReactableTestUtils.testNode());
            });
    ...
    describe('pagination', function () {
        ...
        describe('specifying itemsPerPage', function () {
            before(function () {
                ReactDOM.render(React.createElement(Reactable.Table, { className: 'table', id: 'table', data: [{ 'Name': 'Griffin Smith', 'Age': '18' }, { 'Age': '23', 'Name': 'Lee Salminen' }, { 'Age': '28', 'Position': 'Developer' }, { 'Name': 'Griffin Smith', 'Age': '18' }, { 'Age': '23', 'Name': 'Test Person' }, { 'Name': 'Ian Zhang', 'Age': '28', 'Position': 'Developer' }, { 'Name': 'Griffin Smith', 'Age': '18', 'Position': 'Software Developer' }, { 'Age': '23', 'Name': 'Lee Salminen' }, { 'Age': '28', 'Position': 'Developer' }], itemsPerPage: 4, previousPageLabel: '<<', nextPageLabel: '>>' }), ReactableTestUtils.testNode());
            });
        ...
        describe('updating the currentPage via a prop passed to the table', function () {
            before(function () {
                ...
                var ParentComponent = React.createClass({
                    ...
                    render: function render() {
                        return React.createElement(Reactable.Table, { className: 'table', id: 'table', data: [{ 'Name': 'Griffin Smith', 'Age': '18' }, { 'Age': '23', 'Name': 'Lee Salminen' }, { 'Age': '28', 'Position': 'Developer' }, { 'Name': 'Griffin Smith', 'Age': '18' }, { 'Age': '23', 'Name': 'Test Person' }, { 'Name': 'Ian Zhang', 'Age': '28', 'Position': 'Developer' }, { 'Name': 'Griffin Smith', 'Age': '18', 'Position': 'Software Developer' }, { 'Age': '23', 'Name': 'Lee Salminen' }, { 'Age': '28', 'Position': 'Developer' }], itemsPerPage: 2, currentPage: this.state.currentPage });
                    }
                });
    ...
    describe('sorting', function () {
        ...
        describe('sorting after updating columns and sortable props', function () {
            var parent = void 0;
            ...
            before(function () {
                var TestParent = React.createFactory(React.createClass({
                    ...
                    getInitialState: function getInitialState() {
                        return {
                            data: [{ Name: 'Lee Salminen', Age: '23', Position: 'Programmer' }, { Name: 'Griffin Smith', Age: '18', Position: 'Engineer' }, { Name: 'Ian Zhang', Age: '28', Position: 'Developer' }],
            ...
            it('sorts on new column after receiving new props', function () {
                var newData = [{ Name: 'Lee Salminen', Age: '23', newColumn: 'Programmer' }, { Name: 'Griffin Smith', Age: '18', newColumn: 'Engineer' }, { Name: 'Ian Zhang', Age: '28', newColumn: 'Developer' }];
                var newSortable = ['Name', 'Age', 'newColumn'];
                var newDefaultSort = 'newColumn';
            ...
            before(function () {
                this.component = ReactDOM.render(React.createElement(
                    ...
                    { className: 'table', id: 'table',
                        filterable: [{
                            column: 'Tag',
                            filterFunction: function filterFunction(contents, filter) {
                                // return true if tag contains 'x' and the filter
                                return typeof contents !== 'undefined' && typeof filter !== 'undefined' && contents.indexOf('x') > -1 && contents.indexOf(filter) > -1;
                            }
                        }, 'State'],
                        filterPlaceholder: 'Filter Results',
                        columns: ['State', 'Description', 'Tag'] },
        ...
        before(function () {
            ...
            ReactDOM.render(React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        Reactable.Td,
                        { column: 'Name', onContextMenu: function () {
    ...
    describe('receive props with no currentPage', function () {
        var parent = void 0;
