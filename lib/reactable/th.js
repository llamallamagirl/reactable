...
var Th = function (_React$Component) {
    ...
    _createClass(Th, [{
        ...
        value: function render() {
            ...
            if ((0, _unsafe2.default)(this.props.children)) {
                return _react2.default.createElement('th', _extends({}, (0, _filter_props_from2.default)(this.props), {
                    dangerouslySetInnerHTML: { __html: this.props.children.toString() } }));
            } else {
                return _react2.default.createElement(
                    'th',
                    (0, _filter_props_from2.default)(this.props),
                    this.props.children
                );
            }
        }
